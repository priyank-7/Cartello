				...
				<c:forEach items="${cartItems }" var="item">
					<div class="card mt-3">
						<div class="row no-gutters">
							<div class="col-md-3">
								<img src="${item.getProduct().imageUrl }" class="card-img"
									alt="...">
							</div>
							<div class="col-md-9">
								<div class="card-body">
									<h5 class="card-title">${item.getProduct().productName }</h5>
									<h2>${item.getProduct().price}</h2>
									<p>${item.getProduct().productSize }</p>
									<p>${item.getProduct().productColor }</p>
									<p>${item.quantity }</p>
									<p>
								...
								<div>
									<a
										href="${pageContext.request.contextPath }/removeitem/${item.getProduct().productId }"
				...
				<div class="col text-center">
					<div class="card-footer">
						<a href="${pageContext.request.contextPath }/detail"
							class="btn btn-primary col-md-6 mt-2 mb-4">Buy</a>
					</div>
				</div>
			</div>
